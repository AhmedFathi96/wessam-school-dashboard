                ...
                <div className={styles.default.sliderWrapper}>
                    {
                        BlogPost.map( item=> 
                            <SingleBlogPostCard 
                                id={item._id} 
                                blog_cover_img={`http://localhost:5026/api/blog/get-blog-post-cover-image/${item._id}/view`} 
                                blog_post_img={`http://localhost:5026/api/blog/get-blog-post-image/${item._id}/view`} 
