        ...
        <div>
                <Card>
                    ...
                    <div className={styles.default.sliderWrapper}>
                        {
                            About.map(item=> <SingleAboutCard about_content={item.content} about_header={item.header} about_img={`http://localhost:5026/api/about/get-about-image/${item._id}/view`} id={item._id} order={item.order} />)
                        }
                    </div>
